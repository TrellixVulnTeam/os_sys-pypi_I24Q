README.txt: an index to edit files and the edit menu.

edit is Python's Integrated Development and Learning
Environment.  The user documentation is part of the Library Reference and
is available in edit by selecting Help => edit Help.  This README documents
edit for edit developers and curious users.

editLIB FILES lists files alphabetically by category,
with a short description of each.

edit MENU show the menu tree, annotated with the module
or module object that implements the corresponding function.

This file is descriptive, not prescriptive, and may have errors
and omissions and lag behind changes in edit.


editLIB FILES
Implementation files not in edit MENU are marked (nim).
Deprecated files and objects are listed separately as the end.

Startup
-------
__init__.py  # import, does nothing
__main__.py  # -m, starts edit
edit.bat
edit.py
edit.pyw
...
help.py           # Display edit's html doc.
help_about.py     # Display About edit dialog.
history.py        # Get previous or next user input in shell (nim)
hyperparser.py    # Parse code around a given index.
iomenu.py         # Open, read, and write files
macosx.py         # Help edit run on Macs (nim).
mainmenu.py       # Define most of edit menu.
...
pyshell.py        # Start edit, manage shell, complete editor window
query.py          # Query user for information
redirector.py     # Intercept widget subcommands (for percolator) (nim).
replace.py        # Search and replace pattern in text.
rpc.py            # Commuicate between edit and user processes (nim).
rstrip.py         # Strip trailing whitespace.
run.py            # Manage user code execution subprocess.
runscript.py      # Check and run user code.
scrolledlist.py   # Define scrolledlist widget for edit (nim).
...
Text
----
CREDITS.txt  # not maintained, displayed by About edit
HISTORY.txt  # NEWS up to July 2001
NEWS.txt     # commits, displayed by About edit
README.txt   # this file, displeyed by About edit
TODO.txt     # needs review
extend.txt   # about writing extensions
help.html    # copy of edit.html in docs, displayed by edit Help

Subdirectories
--------------
Icons        # small image files
edit_test    # files for human test and automated unit tests
...
Options
  Configure edit   # eEW.config_dialog, configdialog
    (tabs in the dialog)
...
Help
  About edit       # eEW.about_dialog, help_about.AboutDialog
  ---
  edit Help        # eEW.help_dialog, helpshow_edithelp
