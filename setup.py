...
setuptools.setup(
    name="os_sys",
    version="2.0.3",#.dev moet dan hier
    ...
    packages=list(list(package_data) + ['os_sys', 'edit', 'ins', 'server', 'mysite']),
    install_requires=['pygubu', 'pytz', 'sqlparse', 'progress', 'tqdm', 'progressbar', 'matplotlib', 'numpy',
                      ...
                      "pynput","pythonGui", "pypiwin32", "wmi","enum34","pyvalid","netifaces","psutil",
